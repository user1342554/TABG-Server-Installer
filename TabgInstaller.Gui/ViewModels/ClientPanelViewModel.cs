...
namespace TabgInstaller.Gui.ViewModels
{
    ...
    public partial class ClientPanelViewModel : ObservableObject
    {
        ...
        public static string[] KnownClientMods => PluginRegistry.ClientMods
            .SelectMany(mod => mod.DllNames)
        ...
        {
            return BundledAssetLocator.FindFile(Path.Combine(BundledAssetLocator.ClientPluginsFolder, dllName));
        }
    }
}
