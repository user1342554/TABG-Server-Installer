...
namespace TabgInstaller.Gui.Tabs
{
    public partial class ConfigPanel : UserControl
    {
        ...
        private void RefCommands_Click(object sender, RoutedEventArgs e)
        {
            ReferenceTextBox.Text = @"TABG SERVER COMMANDS REFERENCE
================================
...
- Give yourself a higher perm level by pasting your EpicID from the Guestbook into PlayerPerms.json";
        ...
        private void RefItems_Click(object sender, RoutedEventArgs e)
        {
            ReferenceTextBox.Text = @"TABG ITEM IDS REFERENCE
========================
...
18  Varying Sensitivity";
        ...
        private void RefLoadouts_Click(object sender, RoutedEventArgs e)
        {
            ReferenceTextBox.Text = @"LOADOUT PRESETS REFERENCE
=========================
...
KeepInventory/Ammo and Medkits:100%1:50,2:80,4:50,6:255,6:245,8:100,9:255,9:245,132:5/";
        ...
        private void RefSpawns_Click(object sender, RoutedEventArgs e)
        {
            ReferenceTextBox.Text = @"SPAWN LOCATIONS REFERENCE
==========================
...
CHAOS                  -32,129,-645;-70,133,-635;-71,141,-594;-91,137,-558;-63,131,-513;-24,132,-494;16,137,-515;28,132,-557,10,124,-600";
        ...
        private void RefMatchSettings_Click(object sender, RoutedEventArgs e)
        {
            ReferenceTextBox.Text = @"MATCH SETTINGS GUIDE
=====================
