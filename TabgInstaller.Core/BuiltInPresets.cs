...
namespace TabgInstaller.Core
{
  ...
  },
  {
    ...
    ""value"": """"
        ...
        private static BuiltInPreset MultiplayerShootingRange()
        {
            var gameSettings = @"// Multiplayer Shooting Range generated by TabgInstaller
...
UsePlayFabStats=false";
            ...
            var rangeConfig = @"## Settings file for Range Map Server v1.0.0
## Plugin GUID: tabginstaller.rangemap.server
...
## Granted after every respawn. Press F6 in the paired client mod for every item.
RespawnItems = 52:1,5:255
";

            var files = new Dictionary<string, string>
            {
                ["game_settings.txt"] = gameSettings,
                [Path.Combine("BepInEx", "config", "tabginstaller.rangemap.server.cfg")] = rangeConfig,
            };
